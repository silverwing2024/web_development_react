//firstName과 lastName이라는 상태를 만들기 위해서 코드를 한 번 작성해 보겠습니다. 
// md 파일을 참조해서 일단 작성하고 후에 저와 같이 풀이하고 적용해보겠습니다. 
...
/*
* 혹은 여러개의 const를 작성해서 속성마다 정의하는 것이 아니라
객체의 형태로 정의할 수도 있습니다. 
*/
...
//초기값을 동일하게 집어넣어줘야 하는 귀찮은 일이 있습니다. 
